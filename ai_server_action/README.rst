...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:52f363311ec2dce08947b59f3906de1c802cb9e51f31d3c675b1763b6b66c792
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
This module extends ``ir.actions.server`` with an AI execution state. It
allows Odoo server actions to call an ``ai.connection``, optionally
using ``ai.tool`` records, and to post the result as a message, update a
record field, or store it in an evaluation context variable.

Use cases include cron jobs, automated actions and form buttons that
need to invoke an LLM.
